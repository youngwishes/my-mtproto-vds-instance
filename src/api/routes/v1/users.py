...
from src.services import AddUserServiceV1, RemoveUserServiceV1
...
async def add_new_user(
    ...
    return await AddUserServiceV1(username=username, secret=secret)()
...
async def remove_user(usernames: list[str] = Body(..., embed=True)) -> None:
    return await RemoveUserServiceV1(usernames=usernames)()
